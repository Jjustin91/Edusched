<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            @if ($user->avatar)
                <img src="{{ asset('storage/' . $user->avatar) }}" alt="Avatar" class="h-20 w-20 rounded-full object-cover mt-2 mb-4 border border-gray-700">
            @endif
            ...
            <input id="avatar" name="avatar" type="file" class="mt-1 block w-full text-sm text-gray-400
                  ...
                  hover:file:bg-gray-600" accept="image/*" />
